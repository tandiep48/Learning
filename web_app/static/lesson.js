...
window.onload = async () => {
    try {
        ...
        backBtnContainer.innerHTML = `<a href="/lesson" style="display:inline-block; margin-bottom:20px; color:#3b82f6; text-decoration:none;">← Back to Levels</a>`;
        ...
        data.passages.forEach(p => {
            ...
            btn.onclick = () => startSession(p.passage_id);
