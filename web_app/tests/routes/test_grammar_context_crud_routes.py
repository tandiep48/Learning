...
def test_list_grammar_contexts_endpoint(client):
    with patch("routes.grammar_context_crud_routes.list_grammar_contexts", return_value={
...
def test_get_grammar_context_endpoint_found(client):
    with patch("routes.grammar_context_crud_routes.get_grammar_context", return_value=CONTEXT_DICT):
...
def test_get_grammar_context_endpoint_not_found(client):
    with patch("routes.grammar_context_crud_routes.get_grammar_context",
...
def test_create_grammar_context_endpoint_success(client):
    with patch("routes.grammar_context_crud_routes.create_grammar_context", return_value=CONTEXT_DICT):
...
def test_create_grammar_context_endpoint_service_error(client):
    with patch("routes.grammar_context_crud_routes.create_grammar_context",
...
def test_update_grammar_context_endpoint_success(client):
    ...
    with patch("routes.grammar_context_crud_routes.update_grammar_context", return_value=updated):
...
def test_update_grammar_context_endpoint_not_found(client):
    with patch("routes.grammar_context_crud_routes.update_grammar_context",
               side_effect=GrammarContextServiceError("Grammar context with id=999 not found.", 404)):
...
def test_delete_grammar_context_endpoint_success(client):
    with patch("routes.grammar_context_crud_routes.delete_grammar_context",
