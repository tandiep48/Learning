...
def test_list_grammar_rules_endpoint(client):
    with patch("routes.grammar_rule_crud_routes.list_grammar_rules", return_value={
...
def test_get_grammar_rule_endpoint_found(client):
    with patch("routes.grammar_rule_crud_routes.get_grammar_rule", return_value=RULE_DICT):
...
def test_get_grammar_rule_endpoint_not_found(client):
    with patch("routes.grammar_rule_crud_routes.get_grammar_rule",
...
def test_create_grammar_rule_endpoint_success(client):
    with patch("routes.grammar_rule_crud_routes.create_grammar_rule", return_value=RULE_DICT):
...
def test_create_grammar_rule_endpoint_service_error(client):
    with patch("routes.grammar_rule_crud_routes.create_grammar_rule",
...
def test_update_grammar_rule_endpoint_success(client):
    ...
    with patch("routes.grammar_rule_crud_routes.update_grammar_rule", return_value=updated):
...
def test_update_grammar_rule_endpoint_not_found(client):
    with patch("routes.grammar_rule_crud_routes.update_grammar_rule",
               side_effect=GrammarRuleServiceError("Grammar rule with id=999 not found.", 404)):
...
def test_delete_grammar_rule_endpoint_success(client):
    with patch("routes.grammar_rule_crud_routes.delete_grammar_rule",
